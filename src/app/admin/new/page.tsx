...
import { savePost, generatePostId } from '@/lib/clientPosts';
  ...
  const handleSave = (publish = false) => {
    ...
    try {
      const newPost: BlogPost = {
        ...
        readingTime: 1 // Will be calculated by savePost
      };
...
Write your content here using Markdown syntax. You can use:
